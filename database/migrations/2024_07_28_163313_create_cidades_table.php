...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cidades', function (Blueprint $table) {
            ...
            DB::statement("INSERT INTO `cidades` (`id`, `nome`, `estado_id`) VALUES

        (1, 'Afonso Cláudio', 8),
        (2, 'àgua Doce do Norte', 8),
        (3, 'àguia Branca', 8),
        (4, 'Alegre', 8),
        (5, 'Alfredo Chaves', 8),
        (6, 'Alto Rio Novo', 8),
        ...
        (18, 'Castelo', 8),
        (19, 'Colatina', 8),
        (20, 'Conceià§ão da Barra', 8),
        (21, 'Conceià§ão do Castelo', 8),
        (22, 'Divino de São Lourenà§o', 8),
        ...
        (119, 'Carneiros', 2),
        (120, 'Chã Preta', 2),
        (121, 'Coità© do Nà³ia', 2),
        (122, 'Colà´nia Leopoldina', 2),
        (123, 'Coqueiro Seco', 2),
        (124, 'Coruripe', 2),
        (125, 'Craà­bas', 2),
        ...
        (158, 'Monteirà³polis', 2),
        (159, 'Murici', 2),
        (160, 'Novo Lino', 2),
        (161, 'Olho d`àgua das Flores', 2),
        (162, 'Olho d`àgua do Casado', 2),
        (163, 'Olho d`àgua Grande', 2),
        (164, 'Olivenà§a', 2),
        (165, 'Ouro Branco', 2),
        (166, 'Palestina', 2),
        (167, 'Palmeira dos àndios', 2),
        (168, 'Pão de Aà§àºcar', 2),
        (169, 'Pariconha', 2),
        (170, 'Paripueira', 2),
        ...
        (176, 'Pindoba', 2),
        (177, 'Piranhas', 2),
        (178, 'Poà§o das Trincheiras', 2),
        (179, 'Porto Calvo', 2),
        (180, 'Porto de Pedras', 2),
        (181, 'Porto Real do Colà©gio', 2),
        (182, 'Quebrangulo', 2),
        (183, 'Rio Largo', 2),
        (184, 'Roteiro', 2),
        (185, 'Santa Luzia do Norte', 2),
        (186, 'Santana do Ipanema', 2),
        (187, 'Santana do Mundaàº', 2),
        (188, 'São Brás', 2),
        (189, 'São Josà© da Laje', 2),
        (190, 'São Josà© da Tapera', 2),
        (191, 'São Luà­s do Quitunde', 2),
        ...
        (210, 'Mazagão', 4),
        (211, 'Oiapoque', 4),
        (212, 'Pedra Branca do Amaparà­', 4),
        (213, 'Porto Grande', 4),
        (214, 'Pracuàºba', 4),
        (215, 'Santana', 4),
        (216, 'Serra do Navio', 4),
        (217, 'Tartarugalzinho', 4),
        (218, 'Vità³ria do Jari', 4),
        (219, 'Alvarães', 3),
        (220, 'Amaturá', 3),
        (221, 'Anamã', 3),
        (222, 'Anori', 3),
        ...
        (269, 'Santo Antà´nio do Ià§á', 3),
        (270, 'São Gabriel da Cachoeira', 3),
        (271, 'São Paulo de Olivenà§a', 3),
        ...
        (289, 'Almadina', 5),
        (290, 'Amargosa', 5),
        (291, 'Amà©lia Rodrigues', 5),
        (292, 'Amà©rica Dourada', 5),
        (293, 'Anagà©', 5),
        (294, 'Andaraà­', 5),
        (295, 'Andorinha', 5),
        (296, 'Angical', 5),
        (297, 'Anguera', 5),
        (298, 'Antas', 5),
        (299, 'Antà´nio Cardoso', 5),
        (300, 'Antà´nio Gonà§alves', 5),
        (301, 'Aporá', 5),
        (302, 'Apuarema', 5),
        (303, 'Araà§as', 5),
        (304, 'Aracatu', 5),
        ...
        (333, 'Brejàµes', 5),
        (334, 'Brejolà¢ndia', 5),
        (335, 'Brotas de Macaàºbas', 5),
        (336, 'Brumado', 5),
        (337, 'Buerarema', 5),
        (338, 'Buritirama', 5),
        (339, 'Caatiba', 5),
        (340, 'Cabaceiras do Paraguaà§u', 5),
        (341, 'Cachoeira', 5),
        (342, 'Caculà©', 5),
        (343, 'Caà©m', 5),
        (344, 'Caetanos', 5),
        ...
        (374, 'Central', 5),
        (375, 'Chorrochà³', 5),
        (376, 'Cà­cero Dantas', 5),
        (377, 'Cipà³', 5),
        (378, 'Coaraci', 5),
        (379, 'Cocos', 5),
        (380, 'Conceià§ão da Feira', 5),
        (381, 'Conceià§ão do Almeida', 5),
        (382, 'Conceià§ão do Coità©', 5),
        (383, 'Conceià§ão do Jacuà­pe', 5),
        (384, 'Conde', 5),
        (385, 'Condeàºba', 5),
        (386, 'Contendas do Sincorá', 5),
        (387, 'Coraà§ão de Maria', 5),
        (388, 'Cordeiros', 5),
        (389, 'Coribe', 5),
        ...
        (402, 'Elà­sio Medrado', 5),
        (403, 'Encruzilhada', 5),
        (404, 'Entre Rios', 5),
        (405, 'à‰rico Cardoso', 5),
        (406, 'Esplanada', 5),
        ...
        (461, 'Itagibá', 5),
        (462, 'Itagimirim', 5),
        (463, 'Itaguaà§u da Bahia', 5),
        (464, 'Itaju do Colà´nia', 5),
        (465, 'Itajuà­pe', 5),
        (466, 'Itamaraju', 5),
        (467, 'Itamari', 5),
        (468, 'Itambà©', 5),
        ...
        (512, 'Lenà§à³is', 5),
        (513, 'Licà­nio de Almeida', 5),
        (514, 'Livramento de Nossa Senhora', 5),
        (515, 'Luà­s Eduardo Magalhães', 5),
        (516, 'Macajuba', 5),
        (517, 'Macarani', 5),
        (518, 'Macaàºbas', 5),
        (519, 'Macururà©', 5),
        ...
        (549, 'Muquà©m de São Francisco', 5),
        (550, 'Muritiba', 5),
        (551, 'Mutuà­pe', 5),
        (552, 'Nazarà©', 5),
        (553, 'Nilo Peà§anha', 5),
        ...
        (595, 'Presidente Jà¢nio Quadros', 5),
        ...
        (616, 'Salvador', 5),
        (617, 'Santa Bárbara', 5),
        (618, 'Santa Brà­gida', 5),
        (619, 'Santa Cruz Cabrália', 5),
        (620, 'Santa Cruz da Vità³ria', 5),
        (621, 'Santa Inàªs', 5),
        (622, 'Santa Luzia', 5),
        (623, 'Santa Maria da Vità³ria', 5),
        ...
        (628, 'Santanà³polis', 5),
        (629, 'Santo Amaro', 5),
        (630, 'Santo Antà´nio de Jesus', 5),
        (631, 'Santo Estàªvão', 5),
        (632, 'São Desidà©rio', 5),
        (633, 'São Domingos', 5),
        (634, 'São Felipe', 5),
        (635, 'São Fà©lix', 5),
        (636, 'São Fà©lix do Coribe', 5),
        (637, 'São Francisco do Conde', 5),
        (638, 'São Gabriel', 5),
        (639, 'São Gonà§alo dos Campos', 5),
        (640, 'São Josà© da Vità³ria', 5),
        (641, 'São Josà© do Jacuà­pe', 5),
        (642, 'São Miguel das Matas', 5),
        (643, 'São Sebastião do Passà©', 5),
        (644, 'Sapeaà§u', 5),
        (645, 'Sátiro Dias', 5),
        (646, 'Saubara', 5),
        (647, 'Saàºde', 5),
        ...
        (656, 'Serrolà¢ndia', 5),
        (657, 'Simàµes Filho', 5),
        (658, 'Sà­tio do Mato', 5),
        (659, 'Sà­tio do Quinto', 5),
        (660, 'Sobradinho', 5),
        (661, 'Souto Soares', 5),
        ...
        (685, 'Valenà§a', 5),
        (686, 'Valente', 5),
        (687, 'Várzea da Roà§a', 5),
        (688, 'Várzea do Poà§o', 5),
        (689, 'Várzea Nova', 5),
        (690, 'Varzedo', 5),
        (691, 'Vera Cruz', 5),
        (692, 'Vereda', 5),
        (693, 'Vità³ria da Conquista', 5),
        (694, 'Wagner', 5),
        (695, 'Wanderley', 5),
        ...
        (853, 'Saboeiro', 6),
        (854, 'Salitre', 6),
        (855, 'Santa Quità©ria', 6),
        (856, 'Santana do Acaraàº', 6),
        (857, 'Santana do Cariri', 6),
        (858, 'São Benedito', 6),
        (859, 'São Gonà§alo do Amarante', 6),
        (860, 'São João do Jaguaribe', 6),
        (861, 'São Luà­s do Curu', 6),
        ...
        (879, 'Varjota', 6),
        (880, 'Várzea Alegre', 6),
        (881, 'Vià§osa do Ceará', 6),
        (882, 'Brasà­lia', 7),
        (883, 'Abadia de Goiás', 9),
        (884, 'Abadià¢nia', 9),
        (885, 'Acreàºna', 9),
        (886, 'Adelà¢ndia', 9),
        (887, 'àgua Fria de Goiás', 9),
        (888, 'àgua Limpa', 9),
        (889, 'àguas Lindas de Goiás', 9),
        (890, 'Alexà¢nia', 9),
        (891, 'Aloà¢ndia', 9),
        (892, 'Alto Horizonte', 9),
        (893, 'Alto Paraà­so de Goiás', 9),
        ...
        (1039, 'Nerà³polis', 9),
        (1040, 'Niquelà¢ndia', 9),
        (1041, 'Nova Amà©rica', 9),
        (1042, 'Nova Aurora', 9),
        (1043, 'Nova Crixás', 9),
        (1044, 'Nova Glà³ria', 9),
        (1045, 'Nova Iguaà§u de Goiás', 9),
        (1046, 'Nova Roma', 9),
        (1047, 'Nova Veneza', 9),
        (1048, 'Novo Brasil', 9),
        (1049, 'Novo Gama', 9),
        ...
        (1076, 'Quirinà³polis', 9),
        (1077, 'Rialma', 9),
        (1078, 'Rianápolis', 9),
        (1079, 'Rio Quente', 9),
        (1080, 'Rio Verde', 9),
        (1081, 'Rubiataba', 9),
        (1082, 'Sanclerlà¢ndia', 9),
        (1083, 'Santa Bárbara de Goiás', 9),
        (1084, 'Santa Cruz de Goiás', 9),
        (1085, 'Santa Fà© de Goiás', 9),
        ...
        (1093, 'Santo Antà´nio da Barra', 9),
        (1094, 'Santo Antà´nio de Goiás', 9),
        (1095, 'Santo Antà´nio do Descoberto', 9),
        (1096, 'São Domingos', 9),
        (1097, 'São Francisco de Goiás', 9),
        (1098, 'São João d`Alianà§a', 9),
        (1099, 'São João da Paraàºna', 9),
        (1100, 'São Luà­s de Montes Belos', 9),
        (1101, 'São Luà­z do Norte', 9),
        (1102, 'São Miguel do Araguaia', 9),
        (1103, 'São Miguel do Passa Quatro', 9),
        (1104, 'São Patrà­cio', 9),
        (1105, 'São Simão', 9),
        (1106, 'Senador Canedo', 9),
        (1107, 'Serranà³polis', 9),
        (1108, 'Silvà¢nia', 9),
        (1109, 'Simolà¢ndia', 9),
        (1110, 'Sà­tio d`Abadia', 9),
        (1111, 'Taquaral de Goiás', 9),
        (1112, 'Teresina de Goiás', 9),
        (1113, 'Terezà³polis de Goiás', 9),
        (1114, 'Tràªs Ranchos', 9),
        (1115, 'Trindade', 9),
        (1116, 'Trombas', 9),
        (1117, 'Turvà¢nia', 9),
        (1118, 'Turvelà¢ndia', 9),
        ...
        (1121, 'Uruana', 9),
        (1122, 'Urutaà­', 9),
        (1123, 'Valparaà­so de Goiás', 9),
        (1124, 'Varjão', 9),
        (1125, 'Vianà³polis', 9),
        (1126, 'Vicentinà³polis', 9),
        (1127, 'Vila Boa', 9),
        (1128, 'Vila Propà­cio', 9),
        (1129, 'Aà§ailà¢ndia', 10),
        (1130, 'Afonso Cunha', 10),
        (1131, 'àgua Doce do Maranhão', 10),
        (1132, 'Alcà¢ntara', 10),
        (1133, 'Aldeias Altas', 10),
        (1134, 'Altamira do Maranhão', 10),
        (1135, 'Alto Alegre do Maranhão', 10),
        (1136, 'Alto Alegre do Pindarà©', 10),
        (1137, 'Alto Parnaà­ba', 10),
        ...
        (1188, 'Coelho Neto', 10),
        (1189, 'Colinas', 10),
        (1190, 'Conceià§ão do Lago-Aà§u', 10),
        (1191, 'Coroatá', 10),
        (1192, 'Cururupu', 10),
        (1193, 'Davinà³polis', 10),
        (1194, 'Dom Pedro', 10),
        (1195, 'Duque Bacelar', 10),
        (1196, 'Esperantinà³polis', 10),
        (1197, 'Estreito', 10),
        ...
        (1256, 'Olho d`àgua das Cunhãs', 10),
        (1257, 'Olinda Nova do Maranhão', 10),
        (1258, 'Paà§o do Lumiar', 10),
        (1259, 'Palmeirà¢ndia', 10),
        (1260, 'Paraibano', 10),
        (1261, 'Parnarama', 10),
        ...
        (1341, 'Viana', 10),
        (1342, 'Vila Nova dos Martà­rios', 10),
        (1343, 'Vità³ria do Mearim', 10),
        ...
        (1358, 'Arenápolis', 13),
        (1359, 'Aripuanã', 13),
        (1360, 'Barão de Melgaà§o', 13),
        (1361, 'Barra do Bugres', 13),
        (1362, 'Barra do Garà§as', 13),
        ...
        (1382, 'Cotriguaà§u', 13),
        (1383, 'Cuiabá', 13),
        (1384, 'Curvelà¢ndia', 13),
        (1385, 'Curvelà¢ndia', 13),
        (1386, 'Denise', 13),
        (1387, 'Diamantino', 13),
        (1388, 'Dom Aquino', 13),
        (1389, 'Feliz Natal', 13),
        (1390, 'Figueirà³polis d`Oeste', 13),
        (1391, 'Gaàºcha do Norte', 13),
        (1392, 'General Carneiro', 13),
        (1393, 'Glà³ria d`Oeste', 13),
        ...
        (1463, 'Santo Antà´nio do Leste', 13),
        (1464, 'Santo Antà´nio do Leverger', 13),
        (1465, 'São Fà©lix do Araguaia', 13),
        (1466, 'São Josà© do Povo', 13),
        (1467, 'São Josà© do Rio Claro', 13),
        (1468, 'São Josà© do Xingu', 13),
        (1469, 'São Josà© dos Quatro Marcos', 13),
        ...
        (1484, 'Vera', 13),
        (1485, 'Vila Bela da Santà­ssima Trindade', 13),
        (1486, 'Vila Rica', 13),
        (1487, 'àgua Clara', 12),
        (1488, 'Alcinà³polis', 12),
        (1489, 'Amambaà­', 12),
        (1490, 'Anastácio', 12),
        (1491, 'Anaurilà¢ndia', 12),
        (1492, 'Angà©lica', 12),
        (1493, 'Antà´nio João', 12),
        ...
        (1501, 'Bodoquena', 12),
        (1502, 'Bonito', 12),
        (1503, 'Brasilà¢ndia', 12),
        (1504, 'Caarapà³', 12),
        (1505, 'Camapuã', 12),
        (1506, 'Campo Grande', 12),
        (1507, 'Caracol', 12),
        (1508, 'Cassilà¢ndia', 12),
        ...
        (1556, 'Selvà­ria', 12),
        (1557, 'Sete Quedas', 12),
        (1558, 'Sidrolà¢ndia', 12),
        (1559, 'Sonora', 12),
        (1560, 'Tacuru', 12),
        (1561, 'Taquarussu', 12),
        (1562, 'Terenos', 12),
        (1563, 'Tràªs Lagoas', 12),
        (1564, 'Vicentina', 12),
        ...
        (1569, 'Aà§ucena', 11),
        (1570, 'àgua Boa', 11),
        (1571, 'àgua Comprida', 11),
        (1572, 'Aguanil', 11),
        (1573, 'àguas Formosas', 11),
        (1574, 'àguas Vermelhas', 11),
        (1575, 'Aimorà©s', 11),
        (1576, 'Aiuruoca', 11),
        (1577, 'Alagoa', 11),
        (1578, 'Albertina', 11),
        (1579, 'Alà©m Paraà­ba', 11),
        (1580, 'Alfenas', 11),
        (1581, 'Alfredo Vasconcelos', 11),
        (1582, 'Almenara', 11),
        (1583, 'Alpercata', 11),
        (1584, 'Alpinà³polis', 11),
        (1585, 'Alterosa', 11),
        (1586, 'Alto Caparaà³', 11),
        (1587, 'Alto Jequitibá', 11),
        (1588, 'Alto Rio Doce', 11),
        (1589, 'Alvarenga', 11),
        (1590, 'Alvinà³polis', 11),
        (1591, 'Alvorada de Minas', 11),
        (1592, 'Amparo do Serra', 11),
        (1593, 'Andradas', 11),
        (1594, 'Andrelà¢ndia', 11),
        (1595, 'Angelà¢ndia', 11),
        (1596, 'Antà´nio Carlos', 11),
        (1597, 'Antà´nio Dias', 11),
        (1598, 'Antà´nio Prado de Minas', 11),
        (1599, 'Araà§aà­', 11),
        (1600, 'Aracitaba', 11),
        (1601, 'Araà§uaà­', 11),
        (1602, 'Araguari', 11),
        ...
        (1649, 'Bom Sucesso', 11),
        (1650, 'Bonfim', 11),
        (1651, 'Bonfinà³polis de Minas', 11),
        (1652, 'Bonito de Minas', 11),
        (1653, 'Borda da Mata', 11),
        (1654, 'Botelhos', 11),
        (1655, 'Botumirim', 11),
        (1656, 'Brás Pires', 11),
        (1657, 'Brasilà¢ndia de Minas', 11),
        (1658, 'Brasà­lia de Minas', 11),
        (1659, 'Brasà³polis', 11),
        (1660, 'Braàºnas', 11),
        (1661, 'Brumadinho', 11),
        ...
        (1671, 'Cachoeira de Pajeàº', 11),
        (1672, 'Cachoeira Dourada', 11),
        (1673, 'Caetanà³polis', 11),
        (1674, 'Caetà©', 11),
        (1675, 'Caiana', 11),
        (1676, 'Cajuri', 11),
        (1677, 'Caldas', 11),
        ...
        (1702, 'Capinà³polis', 11),
        (1703, 'Capitão Andrade', 11),
        (1704, 'Capitão Enà©as', 11),
        (1705, 'Capità³lio', 11),
        (1706, 'Caputira', 11),
        (1707, 'Caraà­', 11),
        (1708, 'Caranaà­ba', 11),
        ...
        (1720, 'Carmo do Paranaà­ba', 11),
        (1721, 'Carmo do Rio Claro', 11),
        (1722, 'Carmà³polis de Minas', 11),
        (1723, 'Carneirinho', 11),
        (1724, 'Carrancas', 11),
        (1725, 'Carvalhà³polis', 11),
        (1726, 'Carvalhos', 11),
        (1727, 'Casa Grande', 11),
        ...
        (1734, 'Catuti', 11),
        (1735, 'Caxambu', 11),
        (1736, 'Cedro do Abaetà©', 11),
        (1737, 'Central de Minas', 11),
        (1738, 'Centralina', 11),
        (1739, 'Chácara', 11),
        (1740, 'Chalà©', 11),
        (1741, 'Chapada do Norte', 11),
        (1742, 'Chapada Gaàºcha', 11),
        (1743, 'Chiador', 11),
        (1744, 'Cipotà¢nea', 11),
        (1745, 'Claraval', 11),
        (1746, 'Claro dos Poà§àµes', 11),
        (1747, 'Cláudio', 11),
        (1748, 'Coimbra', 11),
        (1749, 'Coluna', 11),
        (1750, 'Comendador Gomes', 11),
        (1751, 'Comercinho', 11),
        (1752, 'Conceià§ão da Aparecida', 11),
        (1753, 'Conceià§ão da Barra de Minas', 11),
        (1754, 'Conceià§ão das Alagoas', 11),
        (1755, 'Conceià§ão das Pedras', 11),
        (1756, 'Conceià§ão de Ipanema', 11),
        (1757, 'Conceià§ão do Mato Dentro', 11),
        (1758, 'Conceià§ão do Pará', 11),
        (1759, 'Conceià§ão do Rio Verde', 11),
        (1760, 'Conceià§ão dos Ouros', 11),
        (1761, 'Cà´nego Marinho', 11),
        (1762, 'Confins', 11),
        (1763, 'Congonhal', 11),
        (1764, 'Congonhas', 11),
        ...
        (1770, 'Contagem', 11),
        (1771, 'Coqueiral', 11),
        (1772, 'Coraà§ão de Jesus', 11),
        (1773, 'Cordisburgo', 11),
        (1774, 'Cordislà¢ndia', 11),
        (1775, 'Corinto', 11),
        (1776, 'Coroaci', 11),
        (1777, 'Coromandel', 11),
        ...
        (1782, 'Cà³rrego Danta', 11),
        (1783, 'Cà³rrego do Bom Jesus', 11),
        (1784, 'Cà³rrego Fundo', 11),
        (1785, 'Cà³rrego Novo', 11),
        ...
        (1811, 'Divinolà¢ndia de Minas', 11),
        (1812, 'Divinà³polis', 11),
        (1813, 'Divisa Alegre', 11),
        (1814, 'Divisa Nova', 11),
        (1815, 'Divisà³polis', 11),
        (1816, 'Dom Bosco', 11),
        (1817, 'Dom Cavati', 11),
        (1818, 'Dom Joaquim', 11),
        (1819, 'Dom Silvà©rio', 11),
        (1820, 'Dom Vià§oso', 11),
        (1821, 'Dona Eusà©bia', 11),
        (1822, 'Dores de Campos', 11),
        (1823, 'Dores de Guanhães', 11),
        (1824, 'Dores do Indaiá', 11),
        (1825, 'Dores do Turvo', 11),
        (1826, 'Doresà³polis', 11),
        (1827, 'Douradoquara', 11),
        (1828, 'Durandà©', 11),
        (1829, 'Elà³i Mendes', 11),
        ...
        (1837, 'Espinosa', 11),
        (1838, 'Espà­rito Santo do Dourado', 11),
        (1839, 'Estiva', 11),
        (1840, 'Estrela Dalva', 11),
        (1841, 'Estrela do Indaiá', 11),
        (1842, 'Estrela do Sul', 11),
        (1843, 'Eugenà³polis', 11),
        (1844, 'Ewbank da Cà¢mara', 11),
        (1845, 'Extrema', 11),
        (1846, 'Fama', 11),
        (1847, 'Faria Lemos', 11),
        (1848, 'Felà­cio dos Santos', 11),
        (1849, 'Felisburgo', 11),
        (1850, 'Felixlà¢ndia', 11),
        ...
        (1859, 'Francisco Badarà³', 11),
        (1860, 'Francisco Dumont', 11),
        (1861, 'Francisco Sá', 11),
        (1862, 'Franciscà³polis', 11),
        (1863, 'Frei Gaspar', 11),
        (1864, 'Frei Inocàªncio', 11),
        ...
        (1901, 'Ibiraci', 11),
        (1902, 'Ibirità©', 11),
        (1903, 'Ibitiàºra de Minas', 11),
        (1904, 'Ibituruna', 11),
        (1905, 'Icaraà­ de Minas', 11),
        (1906, 'Igarapà©', 11),
        (1907, 'Igaratinga', 11),
        (1908, 'Iguatama', 11),
        (1909, 'Ijaci', 11),
        (1910, 'Ilicà­nea', 11),
        (1911, 'Imbà© de Minas', 11),
        (1912, 'Inconfidentes', 11),
        (1913, 'Indaiabira', 11),
        (1914, 'Indianà³polis', 11),
        (1915, 'Ingaà­', 11),
        (1916, 'Inhapim', 11),
        (1917, 'Inhaàºma', 11),
        (1918, 'Inimutaba', 11),
        ...
        (1977, 'Joaquim Felà­cio', 11),
        (1978, 'Jordà¢nia', 11),
        (1979, 'Josà© Gonà§alves de Minas', 11),
        (1980, 'Josà© Raydan', 11),
        (1981, 'Josenà³polis', 11),
        (1982, 'Juatuba', 11),
        ...
        (2093, 'Novorizonte', 11),
        (2094, 'Olaria', 11),
        (2095, 'Olhos-d`àgua', 11),
        (2096, 'Olà­mpio Noronha', 11),
        (2097, 'Oliveira', 11),
        (2098, 'Oliveira Fortes', 11),
        (2099, 'Onà§a de Pitangui', 11),
        (2100, 'Oratà³rios', 11),
        (2101, 'Orizà¢nia', 11),
        (2102, 'Ouro Branco', 11),
        (2103, 'Ouro Fino', 11),
        ...
        (2127, 'Patrocà­nio', 11),
        (2128, 'Patrocà­nio do Muriaà©', 11),
        (2129, 'Paula Cà¢ndido', 11),
        (2130, 'Paulistas', 11),
        (2131, 'Pavão', 11),
        (2132, 'Peà§anha', 11),
        (2133, 'Pedra Azul', 11),
        ...
        (2231, 'Santa Bárbara do Tugàºrio', 11),
        (2232, 'Santa Cruz de Minas', 11),
        (2233, 'Santa Cruz de Salinas', 11),
        (2234, 'Santa Cruz do Escalvado', 11),
        (2235, 'Santa Efigàªnia de Minas', 11),
        (2236, 'Santa Fà© de Minas', 11),
        ...
        (2243, 'Santa Maria do Suaà§uà­', 11),
        ...
        (2249, 'Santa Rita do Sapucaà­', 11),
        (2250, 'Santa Rosa da Serra', 11),
        (2251, 'Santa Vità³ria', 11),
        (2252, 'Santana da Vargem', 11),
        (2253, 'Santana de Cataguases', 11),
        (2254, 'Santana de Pirapama', 11),
        (2255, 'Santana do Deserto', 11),
        (2256, 'Santana do Garambà©u', 11),
        (2257, 'Santana do Jacarà©', 11),
        (2258, 'Santana do Manhuaà§u', 11),
        (2259, 'Santana do Paraà­so', 11),
        (2260, 'Santana do Riacho', 11),
        (2261, 'Santana dos Montes', 11),
        (2262, 'Santo Antà´nio do Amparo', 11),
        (2263, 'Santo Antà´nio do Aventureiro', 11),
        (2264, 'Santo Antà´nio do Grama', 11),
        (2265, 'Santo Antà´nio do Itambà©', 11),
        (2266, 'Santo Antà´nio do Jacinto', 11),
        (2267, 'Santo Antà´nio do Monte', 11),
        (2268, 'Santo Antà´nio do Retiro', 11),
        (2269, 'Santo Antà´nio do Rio Abaixo', 11),
        (2270, 'Santo Hipà³lito', 11),
        (2271, 'Santos Dumont', 11),
        (2272, 'São Bento Abade', 11),
        (2273, 'São Brás do Suaà§uà­', 11),
        (2274, 'São Domingos das Dores', 11),
        (2275, 'São Domingos do Prata', 11),
        (2276, 'São Fà©lix de Minas', 11),
        (2277, 'São Francisco', 11),
        (2278, 'São Francisco de Paula', 11),
        (2279, 'São Francisco de Sales', 11),
        (2280, 'São Francisco do Glà³ria', 11),
        (2281, 'São Geraldo', 11),
        (2282, 'São Geraldo da Piedade', 11),
        (2283, 'São Geraldo do Baixio', 11),
        (2284, 'São Gonà§alo do Abaetà©', 11),
        (2285, 'São Gonà§alo do Pará', 11),
        (2286, 'São Gonà§alo do Rio Abaixo', 11),
        (2287, 'São Gonà§alo do Rio Preto', 11),
        (2288, 'São Gonà§alo do Sapucaà­', 11),
        (2289, 'São Gotardo', 11),
        (2290, 'São João Batista do Glà³ria', 11),
        (2291, 'São João da Lagoa', 11),
        (2292, 'São João da Mata', 11),
        (2293, 'São João da Ponte', 11),
        (2294, 'São João das Missàµes', 11),
        (2295, 'São João del Rei', 11),
        (2296, 'São João do Manhuaà§u', 11),
        (2297, 'São João do Manteninha', 11),
        (2298, 'São João do Oriente', 11),
        (2299, 'São João do Pacuà­', 11),
        (2300, 'São João do Paraà­so', 11),
        (2301, 'São João Evangelista', 11),
        (2302, 'São João Nepomuceno', 11),
        (2303, 'São Joaquim de Bicas', 11),
        (2304, 'São Josà© da Barra', 11),
        (2305, 'São Josà© da Lapa', 11),
        (2306, 'São Josà© da Safira', 11),
        (2307, 'São Josà© da Varginha', 11),
        (2308, 'São Josà© do Alegre', 11),
        (2309, 'São Josà© do Divino', 11),
        (2310, 'São Josà© do Goiabal', 11),
        (2311, 'São Josà© do Jacuri', 11),
        (2312, 'São Josà© do Mantimento', 11),
        (2313, 'São Lourenà§o', 11),
        (2314, 'São Miguel do Anta', 11),
        (2315, 'São Pedro da União', 11),
        (2316, 'São Pedro do Suaà§uà­', 11),
        ...
        (2339, 'Senador Josà© Bento', 11),
        (2340, 'Senador Modestino Gonà§alves', 11),
        (2341, 'Senhora de Oliveira', 11),
        (2342, 'Senhora do Porto', 11),
        (2343, 'Senhora dos Remà©dios', 11),
        (2344, 'Sericita', 11),
        (2345, 'Seritinga', 11),
        (2346, 'Serra Azul de Minas', 11),
        (2347, 'Serra da Saudade', 11),
        (2348, 'Serra do Salitre', 11),
        (2349, 'Serra dos Aimorà©s', 11),
        (2350, 'Serrania', 11),
        (2351, 'Serranà³polis de Minas', 11),
        (2352, 'Serranos', 11),
        (2353, 'Serro', 11),
        (2354, 'Sete Lagoas', 11),
        (2355, 'Setubinha', 11),
        (2356, 'Silveirà¢nia', 11),
        (2357, 'Silvianà³polis', 11),
        ...
        (2365, 'Tapira', 11),
        (2366, 'Tapiraà­', 11),
        (2367, 'Taquaraà§u de Minas', 11),
        (2368, 'Tarumirim', 11),
        (2369, 'Teixeiras', 11),
        (2370, 'Teà³filo Otoni', 11),
        (2371, 'Timà³teo', 11),
        (2372, 'Tiradentes', 11),
        (2373, 'Tiros', 11),
        (2374, 'Tocantins', 11),
        ...
        (2376, 'Toledo', 11),
        (2377, 'Tombos', 11),
        (2378, 'Tràªs Coraà§àµes', 11),
        (2379, 'Tràªs Marias', 11),
        (2380, 'Tràªs Pontas', 11),
        (2381, 'Tumiritinga', 11),
        (2382, 'Tupaciguara', 11),
        (2383, 'Turmalina', 11),
        (2384, 'Turvolà¢ndia', 11),
        (2385, 'Ubá', 11),
        (2386, 'Ubaà­', 11),
        (2387, 'Ubaporanga', 11),
        (2388, 'Uberaba', 11),
        ...
        (2402, 'Varzelà¢ndia', 11),
        (2403, 'Vazante', 11),
        (2404, 'Verdelà¢ndia', 11),
        (2405, 'Veredinha', 11),
        (2406, 'Verà­ssimo', 11),
        ...
        (2412, 'Virgà­nia', 11),
        (2413, 'Virginà³polis', 11),
        (2414, 'Virgolà¢ndia', 11),
        ...
        (2451, 'Capanema', 14),
        (2452, 'Capitão Poà§o', 14),
        (2453, 'Castanhal', 14),
        (2454, 'Chaves', 14),
        (2455, 'Colares', 14),
        (2456, 'Conceià§ão do Araguaia', 14),
        (2457, 'Concà³rdia do Pará', 14),
        (2458, 'Cumaru do Norte', 14),
        (2459, 'Curionà³polis', 14),
        (2460, 'Curralinho', 14),
        (2461, 'Curuá', 14),
        (2462, 'Curuà§á', 14),
        (2463, 'Dom Eliseu', 14),
        ...
        (2468, 'Goianà©sia do Pará', 14),
        (2469, 'Gurupá', 14),
        (2470, 'Igarapà©-Aà§u', 14),
        (2471, 'Igarapà©-Miri', 14),
        (2472, 'Inhangapi', 14),
        ...
        (2485, 'Marapanim', 14),
        (2486, 'Marituba', 14),
        (2487, 'Medicilà¢ndia', 14),
        (2488, 'Melgaà§o', 14),
        (2489, 'Mocajuba', 14),
        (2490, 'Moju', 14),
        (2491, 'Monte Alegre', 14),
        (2492, 'Muaná', 14),
        (2493, 'Nova Esperanà§a do Piriá', 14),
        ...
        (2544, 'Sapucaia', 14),
        (2545, 'Senador Josà© Porfà­rio', 14),
        (2546, 'Soure', 14),
        (2547, 'Tailà¢ndia', 14),
        (2548, 'Terra Alta', 14),
        (2549, 'Terra Santa', 14),
        ...
        (2553, 'Tucumã', 14),
        (2554, 'Tucuruà­', 14),
        (2555, 'Ulianà³polis', 14),
        (2556, 'Uruará', 14),
        (2557, 'Vigia', 14),
        (2558, 'Viseu', 14),
        (2559, 'Vità³ria do Xingu', 14),
        (2560, 'Xinguara', 14),
        (2561, 'àgua Branca', 15),
        (2562, 'Aguiar', 15),
        (2563, 'Alagoa Grande', 15),
        (2564, 'Alagoa Nova', 15),
        (2565, 'Alagoinha', 15),
        (2566, 'Alcantil', 15),
        (2567, 'Algodão de Jandaà­ra', 15),
        (2568, 'Alhandra', 15),
        (2569, 'Amparo', 15),
        (2570, 'Aparecida', 15),
        (2571, 'Araà§agi', 15),
        ...
        (2573, 'Araruna', 15),
        (2574, 'Areia', 15),
        (2575, 'Areia de Baraàºnas', 15),
        (2576, 'Areial', 15),
        (2577, 'Aroeiras', 15),
        (2578, 'Assunà§ão', 15),
        (2579, 'Baà­a da Traià§ão', 15),
        (2580, 'Bananeiras', 15),
        (2581, 'Baraàºna', 15),
        ...
        (2585, 'Bayeux', 15),
        (2586, 'Belà©m', 15),
        (2587, 'Belà©m do Brejo do Cruz', 15),
        (2588, 'Bernardino Batista', 15),
        (2589, 'Boa Ventura', 15),
        (2590, 'Boa Vista', 15),
        (2591, 'Bom Jesus', 15),
        (2592, 'Bom Sucesso', 15),
        (2593, 'Bonito de Santa Fà©', 15),
        (2594, 'Boqueirão', 15),
        (2595, 'Borborema', 15),
        ...
        (2623, 'Coremas', 15),
        (2624, 'Coxixola', 15),
        (2625, 'Cruz do Espà­rito Santo', 15),
        (2626, 'Cubati', 15),
        (2627, 'Cuità©', 15),
        (2628, 'Cuità© de Mamanguape', 15),
        (2629, 'Cuitegi', 15),
        ...
        (2700, 'Pedro Rà©gis', 15),
        (2701, 'Piancà³', 15),
        (2702, 'Picuà­', 15),
        (2703, 'Pilar', 15),
        (2704, 'Pilàµes', 15),
        (2705, 'Pilàµezinhos', 15),
        (2706, 'Pirpirituba', 15),
        (2707, 'Pitimbu', 15),
        (2708, 'Pocinhos', 15),
        (2709, 'Poà§o Dantas', 15),
        (2710, 'Poà§o de Josà© de Moura', 15),
        (2711, 'Pombal', 15),
        (2712, 'Prata', 15),
        ...
        (2720, 'Riachão do Poà§o', 15),
        (2721, 'Riacho de Santo Antà´nio', 15),
        (2722, 'Riacho dos Cavalos', 15),
        (2723, 'Rio Tinto', 15),
        (2724, 'Salgadinho', 15),
        (2725, 'Salgado de São Fà©lix', 15),
        (2726, 'Santa Cecà­lia', 15),
        (2727, 'Santa Cruz', 15),
        ...
        (2745, 'São Josà© da Lagoa Tapada', 15),
        (2746, 'São Josà© de Caiana', 15),
        (2747, 'São Josà© de Espinharas', 15),
        (2748, 'São Josà© de Piranhas', 15),
        (2749, 'São Josà© de Princesa', 15),
        (2750, 'São Josà© do Bonfim', 15),
        (2751, 'São Josà© do Brejo do Cruz', 15),
        (2752, 'São Josà© do Sabugi', 15),
        (2753, 'São Josà© dos Cordeiros', 15),
        (2754, 'São Josà© dos Ramos', 15),
        (2755, 'São Mamede', 15),
        (2756, 'São Miguel de Taipu', 15),
        (2757, 'São Sebastião de Lagoa de Roà§a', 15),
        ...
        (2779, 'Umbuzeiro', 15),
        (2780, 'Várzea', 15),
        (2781, 'Vieirà³polis', 15),
        (2782, 'Vista Serrana', 15),
        (2783, 'Zabelàª', 15),
        (2784, 'Abatiá', 18),
        (2785, 'Adrianà³polis', 18),
        (2786, 'Agudos do Sul', 18),
        (2787, 'Almirante Tamandarà©', 18),
        (2788, 'Altamira do Paraná', 18),
        (2789, 'Alto Paraà­so', 18),
        (2790, 'Alto Paraná', 18),
        ...
        (2815, 'Barra do Jacarà©', 18),
        (2816, 'Barracão', 18),
        (2817, 'Bela Vista da Caroba', 18),
        (2818, 'Bela Vista do Paraà­so', 18),
        (2819, 'Bituruna', 18),
        (2820, 'Boa Esperanà§a', 18),
        (2821, 'Boa Esperanà§a do Iguaà§u', 18),
        (2822, 'Boa Ventura de São Roque', 18),
        (2823, 'Boa Vista da Aparecida', 18),
        (2824, 'Bocaiàºva do Sul', 18),
        (2825, 'Bom Jesus do Sul', 18),
        (2826, 'Bom Sucesso', 18),
        (2827, 'Bom Sucesso do Sul', 18),
        (2828, 'Borrazà³polis', 18),
        (2829, 'Braganey', 18),
        (2830, 'Brasilà¢ndia do Sul', 18),
        (2831, 'Cafeara', 18),
        (2832, 'Cafelà¢ndia', 18),
        ...
        (2846, 'Cà¢ndido de Abreu', 18),
        (2847, 'Candà³i', 18),
        (2848, 'Cantagalo', 18),
        (2849, 'Capanema', 18),
        (2850, 'Capitão Leà´nidas Marques', 18),
        (2851, 'Carambeà­', 18),
        (2852, 'Carlà³polis', 18),
        (2853, 'Cascavel', 18),
        (2854, 'Castro', 18),
        ...
        (2859, 'Chopinzinho', 18),
        (2860, 'Cianorte', 18),
        (2861, 'Cidade Gaàºcha', 18),
        (2862, 'Clevelà¢ndia', 18),
        (2863, 'Colombo', 18),
        (2864, 'Colorado', 18),
        ...
        (2867, 'Contenda', 18),
        (2868, 'Corbà©lia', 18),
        (2869, 'Cornà©lio Procà³pio', 18),
        (2870, 'Coronel Domingos Soares', 18),
        (2871, 'Coronel Vivida', 18),
        (2872, 'Corumbataà­ do Sul', 18),
        (2873, 'Cruz Machado', 18),
        (2874, 'Cruzeiro do Iguaà§u', 18),
        ...
        (2887, 'Enà©as Marques', 18),
        (2888, 'Engenheiro Beltrão', 18),
        (2889, 'Entre Rios do Oeste', 18),
        (2890, 'Esperanà§a Nova', 18),
        (2891, 'Espigão Alto do Iguaà§u', 18),
        (2892, 'Farol', 18),
        (2893, 'Faxinal', 18),
        ...
        (2899, 'Floraà­', 18),
        (2900, 'Floresta', 18),
        (2901, 'Florestà³polis', 18),
        (2902, 'Flà³rida', 18),
        (2903, 'Formosa do Oeste', 18),
        (2904, 'Foz do Iguaà§u', 18),
        ...
        (2919, 'Guaraniaà§u', 18),
        (2920, 'Guarapuava', 18),
        (2921, 'Guaraqueà§aba', 18),
        (2922, 'Guaratuba', 18),
        (2923, 'Honà³rio Serpa', 18),
        (2924, 'Ibaiti', 18),
        (2925, 'Ibema', 18),
        (2926, 'Ibiporã', 18),
        (2927, 'Icaraà­ma', 18),
        ...
        (2939, 'Iretama', 18),
        (2940, 'Itaguajà©', 18),
        (2941, 'Itaipulà¢ndia', 18),
        (2942, 'Itambaracá', 18),
        (2943, 'Itambà©', 18),
        (2944, 'Itapejara d`Oeste', 18),
        (2945, 'Itaperuà§u', 18),
        (2946, 'Itaàºna do Sul', 18),
        (2947, 'Ivaà­', 18),
        (2948, 'Ivaiporã', 18),
        (2949, 'Ivatà©', 18),
        (2950, 'Ivatuba', 18),
        ...
        (2977, 'Luiziana', 18),
        (2978, 'Lunardelli', 18),
        (2979, 'Lupionà³polis', 18),
        (2980, 'Mallet', 18),
        (2981, 'Mamboràª', 18),
        (2982, 'Mandaguaà§u', 18),
        (2983, 'Mandaguari', 18),
        (2984, 'Mandirituba', 18),
        (2985, 'Manfrinà³polis', 18),
        (2986, 'Mangueirinha', 18),
        (2987, 'Manoel Ribas', 18),
        (2988, 'Marechal Cà¢ndido Rondon', 18),
        (2989, 'Maria Helena', 18),
        (2990, 'Marialva', 18),
        (2991, 'Marilà¢ndia do Sul', 18),
        (2992, 'Marilena', 18),
        (2993, 'Mariluz', 18),
        (2994, 'Maringá', 18),
        (2995, 'Marià³polis', 18),
        ...
        (3012, 'Nossa Senhora das Graà§as', 18),
        (3013, 'Nova Alianà§a do Ivaà­', 18),
        (3014, 'Nova Amà©rica da Colina', 18),
        (3015, 'Nova Aurora', 18),
        (3016, 'Nova Cantu', 18),
        (3017, 'Nova Esperanà§a', 18),
        (3018, 'Nova Esperanà§a do Sudoeste', 18),
        (3019, 'Nova Fátima', 18),
        (3020, 'Nova Laranjeiras', 18),
        (3021, 'Nova Londrina', 18),
        (3022, 'Nova Olà­mpia', 18),
        (3023, 'Nova Prata do Iguaà§u', 18),
        ...
        (3046, 'Perobal', 18),
        (3047, 'Pà©rola', 18),
        (3048, 'Pà©rola d`Oeste', 18),
        (3049, 'Piàªn', 18),
        (3050, 'Pinhais', 18),
        (3051, 'Pinhal de São Bento', 18),
        (3052, 'Pinhalão', 18),
        (3053, 'Pinhão', 18),
        (3054, 'Piraà­ do Sul', 18),
        (3055, 'Piraquara', 18),
        (3056, 'Pitanga', 18),
        ...
        (3085, 'Renascenà§a', 18),
        (3086, 'Reserva', 18),
        (3087, 'Reserva do Iguaà§u', 18),
        (3088, 'Ribeirão Claro', 18),
        (3089, 'Ribeirão do Pinhal', 18),
        (3090, 'Rio Azul', 18),
        (3091, 'Rio Bom', 18),
        (3092, 'Rio Bonito do Iguaà§u', 18),
        (3093, 'Rio Branco do Ivaà­', 18),
        (3094, 'Rio Branco do Sul', 18),
        (3095, 'Rio Negro', 18),
        (3096, 'Rolà¢ndia', 18),
        (3097, 'Roncador', 18),
        (3098, 'Rondon', 18),
        (3099, 'Rosário do Ivaà­', 18),
        (3100, 'Sabáudia', 18),
        (3101, 'Salgado Filho', 18),
        (3102, 'Salto do Itararà©', 18),
        (3103, 'Salto do Lontra', 18),
        (3104, 'Santa Amà©lia', 18),
        (3105, 'Santa Cecà­lia do Pavão', 18),
        (3106, 'Santa Cruz de Monte Castelo', 18),
        (3107, 'Santa Fà©', 18),
        (3108, 'Santa Helena', 18),
        (3109, 'Santa Inàªs', 18),
        (3110, 'Santa Isabel do Ivaà­', 18),
        (3111, 'Santa Izabel do Oeste', 18),
        (3112, 'Santa Làºcia', 18),
        (3113, 'Santa Maria do Oeste', 18),
        (3114, 'Santa Mariana', 18),
        (3115, 'Santa Mà´nica', 18),
        (3116, 'Santa Tereza do Oeste', 18),
        (3117, 'Santa Terezinha de Itaipu', 18),
        (3118, 'Santana do Itararà©', 18),
        (3119, 'Santo Antà´nio da Platina', 18),
        (3120, 'Santo Antà´nio do Caiuá', 18),
        (3121, 'Santo Antà´nio do Paraà­so', 18),
        (3122, 'Santo Antà´nio do Sudoeste', 18),
        (3123, 'Santo Inácio', 18),
        (3124, 'São Carlos do Ivaà­', 18),
        (3125, 'São Jerà´nimo da Serra', 18),
        (3126, 'São João', 18),
        (3127, 'São João do Caiuá', 18),
        (3128, 'São João do Ivaà­', 18),
        (3129, 'São João do Triunfo', 18),
        (3130, 'São Jorge d`Oeste', 18),
        (3131, 'São Jorge do Ivaà­', 18),
        (3132, 'São Jorge do Patrocà­nio', 18),
        (3133, 'São Josà© da Boa Vista', 18),
        (3134, 'São Josà© das Palmeiras', 18),
        (3135, 'São Josà© dos Pinhais', 18),
        (3136, 'São Manoel do Paraná', 18),
        (3137, 'São Mateus do Sul', 18),
        (3138, 'São Miguel do Iguaà§u', 18),
        (3139, 'São Pedro do Iguaà§u', 18),
        (3140, 'São Pedro do Ivaà­', 18),
        (3141, 'São Pedro do Paraná', 18),
        (3142, 'São Sebastião da Amoreira', 18),
        (3143, 'São Tomà©', 18),
        (3144, 'Sapopema', 18),
        (3145, 'Sarandi', 18),
        (3146, 'Saudade do Iguaà§u', 18),
        (3147, 'Sengà©s', 18),
        (3148, 'Serranà³polis do Iguaà§u', 18),
        (3149, 'Sertaneja', 18),
        (3150, 'Sertanà³polis', 18),
        ...
        (3164, 'Toledo', 18),
        (3165, 'Tomazina', 18),
        (3166, 'Tràªs Barras do Paraná', 18),
        ...
        (3198, 'Barreiros', 16),
        (3199, 'Belà©m de Maria', 16),
        (3200, 'Belà©m de São Francisco', 16),
        (3201, 'Belo Jardim', 16),
        (3202, 'Betà¢nia', 16),
        (3203, 'Bezerros', 16),
        (3204, 'Bodocà³', 16),
        ...
        (3289, 'Maraial', 16),
        (3290, 'Mirandiba', 16),
        (3291, 'Moreilà¢ndia', 16),
        (3292, 'Moreno', 16),
        (3293, 'Nazarà© da Mata', 16),
        (3294, 'Olinda', 16),
        (3295, 'Orobà³', 16),
        (3296, 'Orocà³', 16),
        (3297, 'Ouricuri', 16),
        ...
        (3336, 'São Josà© da Coroa Grande', 16),
        (3337, 'São Josà© do Belmonte', 16),
        (3338, 'São Josà© do Egito', 16),
        (3339, 'São Lourenà§o da Mata', 16),
        ...
        (3361, 'Venturosa', 16),
        (3362, 'Verdejante', 16),
        (3363, 'Vertente do Là©rio', 16),
        (3364, 'Vertentes', 16),
        (3365, 'Vicàªncia', 16),
        (3366, 'Vità³ria de Santo Antão', 16),
        (3367, 'Xexà©u', 16),
        (3368, 'Acauã', 17),
        (3369, 'Agricolà¢ndia', 17),
        (3370, 'àgua Branca', 17),
        (3371, 'Alagoinha do Piauà­', 17),
        (3372, 'Alegrete do Piauà­', 17),
        (3373, 'Alto Longá', 17),
        (3374, 'Altos', 17),
        (3375, 'Alvorada do Gurguà©ia', 17),
        (3376, 'Amarante', 17),
        (3377, 'Angical do Piauà­', 17),
        (3378, 'Anà­sio de Abreu', 17),
        (3379, 'Antà´nio Almeida', 17),
        (3380, 'Aroazes', 17),
        (3381, 'Aroeiras do Itaim', 17),
        (3382, 'Arraial', 17),
        (3383, 'Assunà§ão do Piauà­', 17),
        (3384, 'Avelino Lopes', 17),
        (3385, 'Baixa Grande do Ribeiro', 17),
        (3386, 'Barra d`Alcà¢ntara', 17),
        (3387, 'Barras', 17),
        (3388, 'Barreiras do Piauà­', 17),
        (3389, 'Barro Duro', 17),
        (3390, 'Batalha', 17),
        (3391, 'Bela Vista do Piauà­', 17),
        (3392, 'Belà©m do Piauà­', 17),
        (3393, 'Beneditinos', 17),
        (3394, 'Bertolà­nia', 17),
        (3395, 'Betà¢nia do Piauà­', 17),
        (3396, 'Boa Hora', 17),
        (3397, 'Bocaina', 17),
        (3398, 'Bom Jesus', 17),
        (3399, 'Bom Princà­pio do Piauà­', 17),
        (3400, 'Bonfim do Piauà­', 17),
        (3401, 'Boqueirão do Piauà­', 17),
        (3402, 'Brasileira', 17),
        (3403, 'Brejo do Piauà­', 17),
        (3404, 'Buriti dos Lopes', 17),
        (3405, 'Buriti dos Montes', 17),
        (3406, 'Cabeceiras do Piauà­', 17),
        (3407, 'Cajazeiras do Piauà­', 17),
        (3408, 'Cajueiro da Praia', 17),
        (3409, 'Caldeirão Grande do Piauà­', 17),
        (3410, 'Campinas do Piauà­', 17),
        (3411, 'Campo Alegre do Fidalgo', 17),
        (3412, 'Campo Grande do Piauà­', 17),
        (3413, 'Campo Largo do Piauà­', 17),
        (3414, 'Campo Maior', 17),
        (3415, 'Canavieira', 17),
        ...
        (3419, 'Caracol', 17),
        (3420, 'Caraàºbas do Piauà­', 17),
        (3421, 'Caridade do Piauà­', 17),
        (3422, 'Castelo do Piauà­', 17),
        (3423, 'Caxingà³', 17),
        (3424, 'Cocal', 17),
        (3425, 'Cocal de Telha', 17),
        (3426, 'Cocal dos Alves', 17),
        (3427, 'Coivaras', 17),
        (3428, 'Colà´nia do Gurguà©ia', 17),
        (3429, 'Colà´nia do Piauà­', 17),
        (3430, 'Conceià§ão do Canindà©', 17),
        (3431, 'Coronel Josà© Dias', 17),
        (3432, 'Corrente', 17),
        (3433, 'Cristalà¢ndia do Piauà­', 17),
        (3434, 'Cristino Castro', 17),
        (3435, 'Curimatá', 17),
        (3436, 'Currais', 17),
        (3437, 'Curral Novo do Piauà­', 17),
        (3438, 'Curralinhos', 17),
        (3439, 'Demerval Lobão', 17),
        (3440, 'Dirceu Arcoverde', 17),
        (3441, 'Dom Expedito Lopes', 17),
        (3442, 'Dom Inocàªncio', 17),
        (3443, 'Domingos Mourão', 17),
        (3444, 'Elesbão Veloso', 17),
        (3445, 'Eliseu Martins', 17),
        (3446, 'Esperantina', 17),
        (3447, 'Fartura do Piauà­', 17),
        (3448, 'Flores do Piauà­', 17),
        (3449, 'Floresta do Piauà­', 17),
        (3450, 'Floriano', 17),
        (3451, 'Francinà³polis', 17),
        ...
        (3461, 'Ilha Grande', 17),
        (3462, 'Inhuma', 17),
        (3463, 'Ipiranga do Piauà­', 17),
        (3464, 'Isaà­as Coelho', 17),
        (3465, 'Itainà³polis', 17),
        (3466, 'Itaueira', 17),
        (3467, 'Jacobina do Piauà­', 17),
        (3468, 'Jaicà³s', 17),
        (3469, 'Jardim do Mulato', 17),
        (3470, 'Jatobá do Piauà­', 17),
        (3471, 'Jerumenha', 17),
        (3472, 'João Costa', 17),
        (3473, 'Joaquim Pires', 17),
        (3474, 'Joca Marques', 17),
        (3475, 'Josà© de Freitas', 17),
        (3476, 'Juazeiro do Piauà­', 17),
        (3477, 'Jàºlio Borges', 17),
        (3478, 'Jurema', 17),
        (3479, 'Lagoa Alegre', 17),
        (3480, 'Lagoa de São Francisco', 17),
        (3481, 'Lagoa do Barro do Piauà­', 17),
        (3482, 'Lagoa do Piauà­', 17),
        (3483, 'Lagoa do Sà­tio', 17),
        (3484, 'Lagoinha do Piauà­', 17),
        (3485, 'Landri Sales', 17),
        (3486, 'Luà­s Correia', 17),
        (3487, 'Luzilà¢ndia', 17),
        (3488, 'Madeiro', 17),
        (3489, 'Manoel Emà­dio', 17),
        (3490, 'Marcolà¢ndia', 17),
        (3491, 'Marcos Parente', 17),
        (3492, 'Massapàª do Piauà­', 17),
        (3493, 'Matias Olà­mpio', 17),
        (3494, 'Miguel Alves', 17),
        (3495, 'Miguel Leão', 17),
        (3496, 'Milton Brandão', 17),
        (3497, 'Monsenhor Gil', 17),
        (3498, 'Monsenhor Hipà³lito', 17),
        (3499, 'Monte Alegre do Piauà­', 17),
        (3500, 'Morro Cabeà§a no Tempo', 17),
        (3501, 'Morro do Chapà©u do Piauà­', 17),
        (3502, 'Murici dos Portelas', 17),
        (3503, 'Nazarà© do Piauà­', 17),
        (3504, 'Nossa Senhora de Nazarà©', 17),
        (3505, 'Nossa Senhora dos Remà©dios', 17),
        (3506, 'Nova Santa Rita', 17),
        (3507, 'Novo Oriente do Piauà­', 17),
        (3508, 'Novo Santo Antà´nio', 17),
        (3509, 'Oeiras', 17),
        (3510, 'Olho d`àgua do Piauà­', 17),
        (3511, 'Padre Marcos', 17),
        (3512, 'Paes Landim', 17),
        (3513, 'Pajeàº do Piauà­', 17),
        (3514, 'Palmeira do Piauà­', 17),
        (3515, 'Palmeirais', 17),
        (3516, 'Paquetá', 17),
        (3517, 'Parnaguá', 17),
        (3518, 'Parnaà­ba', 17),
        (3519, 'Passagem Franca do Piauà­', 17),
        (3520, 'Patos do Piauà­', 17),
        (3521, 'Pau d`Arco do Piauà­', 17),
        (3522, 'Paulistana', 17),
        (3523, 'Pavussu', 17),
        (3524, 'Pedro II', 17),
        ...
        (3530, 'Piripiri', 17),
        (3531, 'Porto', 17),
        (3532, 'Porto Alegre do Piauà­', 17),
        (3533, 'Prata do Piauà­', 17),
        (3534, 'Queimada Nova', 17),
        (3535, 'Redenà§ão do Gurguà©ia', 17),
        (3536, 'Regeneraà§ão', 17),
        (3537, 'Riacho Frio', 17),
        (3538, 'Ribeira do Piauà­', 17),
        (3539, 'Ribeiro Gonà§alves', 17),
        (3540, 'Rio Grande do Piauà­', 17),
        (3541, 'Santa Cruz do Piauà­', 17),
        (3542, 'Santa Cruz dos Milagres', 17),
        (3543, 'Santa Filomena', 17),
        (3544, 'Santa Luz', 17),
        (3545, 'Santa Rosa do Piauà­', 17),
        (3546, 'Santana do Piauà­', 17),
        (3547, 'Santo Antà´nio de Lisboa', 17),
        (3548, 'Santo Antà´nio dos Milagres', 17),
        (3549, 'Santo Inácio do Piauà­', 17),
        (3550, 'São Braz do Piauà­', 17),
        (3551, 'São Fà©lix do Piauà­', 17),
        (3552, 'São Francisco de Assis do Piauà­', 17),
        (3553, 'São Francisco do Piauà­', 17),
        (3554, 'São Gonà§alo do Gurguà©ia', 17),
        (3555, 'São Gonà§alo do Piauà­', 17),
        ...
        (3561, 'São João do Piauà­', 17),
        (3562, 'São Josà© do Divino', 17),
        (3563, 'São Josà© do Peixe', 17),
        (3564, 'São Josà© do Piauà­', 17),
        (3565, 'São Julião', 17),
        (3566, 'São Lourenà§o do Piauà­', 17),
        (3567, 'São Luis do Piauà­', 17),
        (3568, 'São Miguel da Baixa Grande', 17),
        (3569, 'São Miguel do Fidalgo', 17),
        (3570, 'São Miguel do Tapuio', 17),
        (3571, 'São Pedro do Piauà­', 17),
        (3572, 'São Raimundo Nonato', 17),
        (3573, 'Sebastião Barros', 17),
        (3574, 'Sebastião Leal', 17),
        (3575, 'Sigefredo Pacheco', 17),
        (3576, 'Simàµes', 17),
        (3577, 'Simplà­cio Mendes', 17),
        (3578, 'Socorro do Piauà­', 17),
        (3579, 'Sussuapara', 17),
        (3580, 'Tamboril do Piauà­', 17),
        (3581, 'Tanque do Piauà­', 17),
        (3582, 'Teresina', 17),
        (3583, 'União', 17),
        (3584, 'Uruà§uà­', 17),
        (3585, 'Valenà§a do Piauà­', 17),
        (3586, 'Várzea Branca', 17),
        (3587, 'Várzea Grande', 17),
        (3588, 'Vera Mendes', 17),
        (3589, 'Vila Nova do Piauà­', 17),
        (3590, 'Wall Ferraz', 17),
        (3591, 'Angra dos Reis', 19),
        (3592, 'Aperibà©', 19),
        (3593, 'Araruama', 19),
        (3594, 'Areal', 19),
        (3595, 'Armaà§ão dos Bàºzios', 19),
        (3596, 'Arraial do Cabo', 19),
        (3597, 'Barra do Piraà­', 19),
        (3598, 'Barra Mansa', 19),
        ...
        (3640, 'Nova Iguaà§u', 19),
        (3641, 'Paracambi', 19),
        (3642, 'Paraà­ba do Sul', 19),
        (3643, 'Parati', 19),
        (3644, 'Paty do Alferes', 19),
        (3645, 'Petrà³polis', 19),
        (3646, 'Pinheiral', 19),
        (3647, 'Piraà­', 19),
        (3648, 'Porciàºncula', 19),
        (3649, 'Porto Real', 19),
        (3650, 'Quatis', 19),
        (3651, 'Queimados', 19),
        (3652, 'Quissamã', 19),
        ...
        (3660, 'Santo Antà´nio de Pádua', 19),
        (3661, 'São Fidà©lis', 19),
        (3662, 'São Francisco de Itabapoana', 19),
        (3663, 'São Gonà§alo', 19),
        (3664, 'São João da Barra', 19),
        (3665, 'São João de Meriti', 19),
        (3666, 'São Josà© de Ubá', 19),
        (3667, 'São Josà© do Vale do Rio Pret', 19),
        ...
        (3690, 'Angicos', 20),
        (3691, 'Antà´nio Martins', 20),
        (3692, 'Apodi', 20),
        (3693, 'Areia Branca', 20),
        (3694, 'Aràªs', 20),
        (3695, 'Augusto Severo', 20),
        (3696, 'Baà­a Formosa', 20),
        (3697, 'Baraàºna', 20),
        (3698, 'Barcelona', 20),
        ...
        (3701, 'Bom Jesus', 20),
        (3702, 'Brejinho', 20),
        (3703, 'Caià§ara do Norte', 20),
        (3704, 'Caià§ara do Rio do Vento', 20),
        (3705, 'Caicà³', 20),
        (3706, 'Campo Redondo', 20),
        (3707, 'Canguaretama', 20),
        (3708, 'Caraàºbas', 20),
        (3709, 'Carnaàºba dos Dantas', 20),
        (3710, 'Carnaubais', 20),
        (3711, 'Ceará-Mirim', 20),
        (3712, 'Cerro Corá', 20),
        ...
        (3744, 'Jardim do Seridà³', 20),
        (3745, 'João Cà¢mara', 20),
        (3746, 'João Dias', 20),
        (3747, 'Josà© da Penha', 20),
        (3748, 'Jucurutu', 20),
        (3749, 'Jundiá', 20),
        ...
        (3769, 'Mossorà³', 20),
        (3770, 'Natal', 20),
        (3771, 'Nà­sia Floresta', 20),
        (3772, 'Nova Cruz', 20),
        (3773, 'Olho-d`àgua do Borges', 20),
        (3774, 'Ouro Branco', 20),
        (3775, 'Paraná', 20),
        (3776, 'Paraàº', 20),
        (3777, 'Parazinho', 20),
        ...
        (3806, 'Santana do Seridà³', 20),
        (3807, 'Santo Antà´nio', 20),
        (3808, 'São Bento do Norte', 20),
        (3809, 'São Bento do Trairà­', 20),
        (3810, 'São Fernando', 20),
        (3811, 'São Francisco do Oeste', 20),
        (3812, 'São Gonà§alo do Amarante', 20),
        (3813, 'São João do Sabugi', 20),
        (3814, 'São Josà© de Mipibu', 20),
        (3815, 'São Josà© do Campestre', 20),
        (3816, 'São Josà© do Seridà³', 20),
        (3817, 'São Miguel', 20),
        ...
        (3822, 'São Tomà©', 20),
        (3823, 'São Vicente', 20),
        (3824, 'Senador Elà³i de Souza', 20),
        ...
        (3840, 'Timbaàºba dos Batistas', 20),
        (3841, 'Touros', 20),
        ...
        (3855, 'Alegrete', 23),
        (3856, 'Alegria', 23),
        (3857, 'Almirante Tamandarà© do Sul', 23),
        (3858, 'Alpestre', 23),
        (3859, 'Alto Alegre', 23),
        (3860, 'Alto Feliz', 23),
        (3861, 'Alvorada', 23),
        ...
        (3864, 'Andrà© da Rocha', 23),
        (3865, 'Anta Gorda', 23),
        (3866, 'Antà´nio Prado', 23),
        (3867, 'Arambarà©', 23),
        (3868, 'Araricá', 23),
        (3869, 'Aratiba', 23),
        ...
        (3919, 'Campina das Missàµes', 23),
        (3920, 'Campinas do Sul', 23),
        (3921, 'Campo Bom', 23),
        (3922, 'Campo Novo', 23),
        (3923, 'Campos Borges', 23),
        (3924, 'Candelária', 23),
        (3925, 'Cà¢ndido Godà³i', 23),
        (3926, 'Candiota', 23),
        (3927, 'Canela', 23),
        (3928, 'Canguà§u', 23),
        (3929, 'Canoas', 23),
        ...
        (3981, 'Dois Irmãos', 23),
        (3982, 'Dois Irmãos das Missàµes', 23),
        (3983, 'Dois Lajeados', 23),
        (3984, 'Dom Feliciano', 23),
        (3985, 'Dom Pedrito', 23),
        (3986, 'Dom Pedro de Alcà¢ntara', 23),
        (3987, 'Dona Francisca', 23),
        (3988, 'Doutor Maurà­cio Cardoso', 23),
        ...
        (4000, 'Erval Seco', 23),
        (4001, 'Esmeralda', 23),
        (4002, 'Esperanà§a do Sul', 23),
        (4003, 'Espumoso', 23),
        (4004, 'Estaà§ão', 23),
        (4005, 'Està¢ncia Velha', 23),
        (4006, 'Esteio', 23),
        (4007, 'Estrela', 23),
        (4008, 'Estrela Velha', 23),
        (4009, 'Eugàªnio de Castro', 23),
        ...
        (4024, 'Garruchos', 23),
        (4025, 'Gaurama', 23),
        (4026, 'General Cà¢mara', 23),
        (4027, 'Gentil', 23),
        (4028, 'Getàºlio Vargas', 23),
        (4029, 'Giruá', 23),
        (4030, 'Glorinha', 23),
        (4031, 'Gramado', 23),
        ...
        (4074, 'Jari', 23),
        (4075, 'Jà³ia', 23),
        (4076, 'Jàºlio de Castilhos', 23),
        (4077, 'Lagoa Bonita do Sul', 23),
        (4078, 'Lagoa dos Tràªs Cantos', 23),
        ...
        (4124, 'Nova Brà©scia', 23),
        (4125, 'Nova Candelária', 23),
        (4126, 'Nova Esperanà§a do Sul', 23),
        (4127, 'Nova Hartz', 23),
        (4128, 'Nova Pádua', 23),
        (4129, 'Nova Palma', 23),
        (4130, 'Nova Petrà³polis', 23),
        (4131, 'Nova Prata', 23),
        (4132, 'Nova Ramada', 23),
        ...
        (4144, 'Palmeira das Missàµes', 23),
        (4145, 'Palmitinho', 23),
        (4146, 'Panambi', 23),
        (4147, 'Pantano Grande', 23),
        (4148, 'Paraà­', 23),
        (4149, 'Paraà­so do Sul', 23),
        (4150, 'Pareci Novo', 23),
        (4151, 'Parobà©', 23),
        (4152, 'Passa Sete', 23),
        ...
        (4203, 'Sagrada Famà­lia', 23),
        (4204, 'Saldanha Marinho', 23),
        (4205, 'Salto do Jacuà­', 23),
        (4206, 'Salvador das Missàµes', 23),
        (4207, 'Salvador do Sul', 23),
        (4208, 'Sananduva', 23),
        (4209, 'Santa Bárbara do Sul', 23),
        (4210, 'Santa Cecà­lia do Sul', 23),
        ...
        (4218, 'Santa Vità³ria do Palmar', 23),
        (4219, 'Santana da Boa Vista', 23),
        (4220, 'Santana do Livramento', 23),
        (4221, 'Santiago', 23),
        (4222, 'Santo à‚ngelo', 23),
        (4223, 'Santo Antà´nio da Patrulha', 23),
        (4224, 'Santo Antà´nio das Missàµes', 23),
        (4225, 'Santo Antà´nio do Palma', 23),
        (4226, 'Santo Antà´nio do Planalto', 23),
        ...
        (4234, 'São Gabriel', 23),
        (4235, 'São Jerà´nimo', 23),
        (4236, 'São João da Urtiga', 23),
        (4237, 'São João do Polàªsine', 23),
        (4238, 'São Jorge', 23),
        (4239, 'São Josà© das Missàµes', 23),
        (4240, 'São Josà© do Herval', 23),
        (4241, 'São Josà© do Hortàªncio', 23),
        (4242, 'São Josà© do Inhacorá', 23),
        (4243, 'São Josà© do Norte', 23),
        (4244, 'São Josà© do Ouro', 23),
        (4245, 'São Josà© do Sul', 23),
        (4246, 'São Josà© dos Ausentes', 23),
        (4247, 'São Leopoldo', 23),
        (4248, 'São Lourenà§o do Sul', 23),
        (4249, 'São Luiz Gonzaga', 23),
        (4250, 'São Marcos', 23),
        (4251, 'São Martinho', 23),
        (4252, 'São Martinho da Serra', 23),
        (4253, 'São Miguel das Missàµes', 23),
        (4254, 'São Nicolau', 23),
        (4255, 'São Paulo das Missàµes', 23),
        (4256, 'São Pedro da Serra', 23),
        (4257, 'São Pedro das Missàµes', 23),
        (4258, 'São Pedro do Butiá', 23),
        (4259, 'São Pedro do Sul', 23),
        (4260, 'São Sebastião do Caà­', 23),
        (4261, 'São Sepà©', 23),
        (4262, 'São Valentim', 23),
        (4263, 'São Valentim do Sul', 23),
        (4264, 'São Valà©rio do Sul', 23),
        ...
        (4301, 'Tramandaà­', 23),
        (4302, 'Travesseiro', 23),
        (4303, 'Tràªs Arroios', 23),
        (4304, 'Tràªs Cachoeiras', 23),
        (4305, 'Tràªs Coroas', 23),
        (4306, 'Tràªs de Maio', 23),
        (4307, 'Tràªs Forquilhas', 23),
        (4308, 'Tràªs Palmeiras', 23),
        (4309, 'Tràªs Passos', 23),
        ...
        (4326, 'Vale Verde', 23),
        (4327, 'Vanini', 23),
        (4328, 'Venà¢ncio Aires', 23),
        (4329, 'Vera Cruz', 23),
        (4330, 'Veranà³polis', 23),
        ...
        (4373, 'Monte Negro', 21),
        (4374, 'Nova Brasilà¢ndia d`Oeste', 21),
        (4375, 'Nova Mamorà©', 21),
        (4376, 'Nova União', 21),
        ...
        (4382, 'Porto Velho', 21),
        (4383, 'Presidente Mà©dici', 21),
        (4384, 'Primavera de Rondà´nia', 21),
        (4385, 'Rio Crespo', 21),
        (4386, 'Rolim de Moura', 21),
        (4387, 'Santa Luzia d`Oeste', 21),
        (4388, 'São Felipe d`Oeste', 21),
        (4389, 'São Francisco do Guaporà©', 21),
        (4390, 'São Miguel do Guaporà©', 21),
        (4391, 'Seringueiras', 21),
        (4392, 'Teixeirà³polis', 21),
        (4393, 'Theobroma', 21),
        (4394, 'Urupá', 21),
        (4395, 'Vale do Anari', 21),
        (4396, 'Vale do Paraà­so', 21),
        (4397, 'Vilhena', 21),
        (4398, 'Alto Alegre', 22),
        (4399, 'Amajari', 22),
        (4400, 'Boa Vista', 22),
        ...
        (4416, 'Agronà´mica', 24),
        (4417, 'àgua Doce', 24),
        (4418, 'àguas de Chapecà³', 24),
        (4419, 'àguas Frias', 24),
        (4420, 'àguas Mornas', 24),
        ...
        (4455, 'Bombinhas', 24),
        (4456, 'Botuverá', 24),
        (4457, 'Braà§o do Norte', 24),
        (4458, 'Braà§o do Trombudo', 24),
        (4459, 'Brunà³polis', 24),
        (4460, 'Brusque', 24),
        (4461, 'Caà§ador', 24),
        (4462, 'Caibi', 24),
        ...
        (4500, 'Florianà³polis', 24),
        (4501, 'Formosa do Sul', 24),
        (4502, 'Forquilhinha', 24),
        (4503, 'Fraiburgo', 24),
        (4504, 'Frei Rogà©rio', 24),
        (4505, 'Galvão', 24),
        (4506, 'Garopaba', 24),
        (4507, 'Garuva', 24),
        (4508, 'Gaspar', 24),
        ...
        (4547, 'Jardinà³polis', 24),
        (4548, 'Joaà§aba', 24),
        (4549, 'Joinville', 24),
        (4550, 'Josà© Boiteux', 24),
        (4551, 'Jupiá', 24),
        (4552, 'Lacerdà³polis', 24),
        (4553, 'Lages', 24),
        (4554, 'Laguna', 24),
        (4555, 'Lajeado Grande', 24),
        (4556, 'Laurentino', 24),
        (4557, 'Lauro Muller', 24),
        (4558, 'Lebon Rà©gis', 24),
        (4559, 'Leoberto Leal', 24),
        (4560, 'Lindà³ia do Sul', 24),
        (4561, 'Lontras', 24),
        (4562, 'Luiz Alves', 24),
        (4563, 'Luzerna', 24),
        (4564, 'Macieira', 24),
        ...
        (4656, 'São João do Itaperiàº', 24),
        (4657, 'São João do Oeste', 24),
        (4658, 'São João do Sul', 24),
        (4659, 'São Joaquim', 24),
        (4660, 'São Josà©', 24),
        (4661, 'São Josà© do Cedro', 24),
        (4662, 'São Josà© do Cerrito', 24),
        (4663, 'São Lourenà§o do Oeste', 24),
        (4664, 'São Ludgero', 24),
        (4665, 'São Martinho', 24),
        (4666, 'São Miguel da Boa Vista', 24),
        (4667, 'São Miguel do Oeste', 24),
        (4668, 'São Pedro de Alcà¢ntara', 24),
        (4669, 'Saudades', 24),
        (4670, 'Schroeder', 24),
        (4671, 'Seara', 24),
        (4672, 'Serra Alta', 24),
        (4673, 'Siderà³polis', 24),
        (4674, 'Sombrio', 24),
        (4675, 'Sul Brasil', 24),
        (4676, 'Taià³', 24),
        (4677, 'Tangará', 24),
        (4678, 'Tigrinhos', 24),
        (4679, 'Tijucas', 24),
        (4680, 'Timbà© do Sul', 24),
        (4681, 'Timbà³', 24),
        (4682, 'Timbà³ Grande', 24),
        (4683, 'Tràªs Barras', 24),
        (4684, 'Treviso', 24),
        (4685, 'Treze de Maio', 24),
        (4686, 'Treze Tà­lias', 24),
        ...
        (4707, 'Adolfo', 26),
        (4708, 'Aguaà­', 26),
        (4709, 'àguas da Prata', 26),
        (4710, 'àguas de Lindà³ia', 26),
        (4711, 'àguas de Santa Bárbara', 26),
        (4712, 'àguas de São Pedro', 26),
        (4713, 'Agudos', 26),
        (4714, 'Alambari', 26),
        (4715, 'Alfredo Marcondes', 26),
        (4716, 'Altair', 26),
        (4717, 'Altinà³polis', 26),
        (4718, 'Alto Alegre', 26),
        (4719, 'Alumà­nio', 26),
        (4720, 'àlvares Florence', 26),
        (4721, 'àlvares Machado', 26),
        (4722, 'àlvaro de Carvalho', 26),
        (4723, 'Alvinlà¢ndia', 26),
        (4724, 'Americana', 26),
        (4725, 'Amà©rico Brasiliense', 26),
        (4726, 'Amà©rico de Campos', 26),
        (4727, 'Amparo', 26),
        (4728, 'Analà¢ndia', 26),
        (4729, 'Andradina', 26),
        (4730, 'Angatuba', 26),
        ...
        (4735, 'Apiaà­', 26),
        (4736, 'Araà§ariguama', 26),
        (4737, 'Araà§atuba', 26),
        (4738, 'Araà§oiaba da Serra', 26),
        (4739, 'Aramina', 26),
        (4740, 'Arandu', 26),
        (4741, 'Arapeà­', 26),
        (4742, 'Araraquara', 26),
        ...
        (4781, 'Boa Esperanà§a do Sul', 26),
        (4782, 'Bocaina', 26),
        (4783, 'Bofete', 26),
        (4784, 'Boituva', 26),
        (4785, 'Bom Jesus dos Perdàµes', 26),
        (4786, 'Bom Sucesso de Itararà©', 26),
        (4787, 'Borá', 26),
        (4788, 'Boracà©ia', 26),
        (4789, 'Borborema', 26),
        (4790, 'Borebi', 26),
        (4791, 'Botucatu', 26),
        (4792, 'Braganà§a Paulista', 26),
        (4793, 'Braàºna', 26),
        ...
        (4818, 'Cananà©ia', 26),
        (4819, 'Canas', 26),
        (4820, 'Cà¢ndido Mota', 26),
        (4821, 'Cà¢ndido Rodrigues', 26),
        (4822, 'Canitar', 26),
        (4823, 'Capão Bonito', 26),
        (4824, 'Capela do Alto', 26),
        (4825, 'Capivari', 26),
        (4826, 'Caraguatatuba', 26),
        (4827, 'Carapicuà­ba', 26),
        (4828, 'Cardoso', 26),
        (4829, 'Casa Branca', 26),
        ...
        (4859, 'Diadema', 26),
        (4860, 'Dirce Reis', 26),
        (4861, 'Divinolà¢ndia', 26),
        (4862, 'Dobrada', 26),
        (4863, 'Dois Cà³rregos', 26),
        (4864, 'Dolcinà³polis', 26),
        (4865, 'Dourado', 26),
        (4866, 'Dracena', 26),
        (4867, 'Duartina', 26),
        (4868, 'Dumont', 26),
        ...
        (4874, 'Embu', 26),
        (4875, 'Embu-Guaà§u', 26),
        (4876, 'Emilianà³polis', 26),
        (4877, 'Engenheiro Coelho', 26),
        (4878, 'Espà­rito Santo do Pinhal', 26),
        (4879, 'Espà­rito Santo do Turvo', 26),
        ...
        (4886, 'Fernandà³polis', 26),
        (4887, 'Fernão', 26),
        (4888, 'Ferraz de Vasconcelos', 26),
        (4889, 'Flora Rica', 26),
        (4890, 'Floreal', 26),
        (4891, 'Flà³rida Paulista', 26),
        (4892, 'Florà­nia', 26),
        (4893, 'Franca', 26),
        ...
        (4921, 'Guatapará', 26),
        (4922, 'Guzolà¢ndia', 26),
        (4923, 'Herculà¢ndia', 26),
        (4924, 'Holambra', 26),
        (4925, 'Hortolà¢ndia', 26),
        (4926, 'Iacanga', 26),
        (4927, 'Iacri', 26),
        (4928, 'Iaras', 26),
        (4929, 'Ibatà©', 26),
        ...
        (4990, 'Jambeiro', 26),
        (4991, 'Jandira', 26),
        (4992, 'Jardinà³polis', 26),
        (4993, 'Jarinu', 26),
        (4994, 'Jaàº', 26),
        (4995, 'Jeriquara', 26),
        (4996, 'Joanà³polis', 26),
        (4997, 'João Ramalho', 26),
        (4998, 'Josà© Bonifácio', 26),
        (4999, 'Jàºlio Mesquita', 26),
        (5000, 'Jumirim', 26),
        (5001, 'Jundiaà­', 26),
        (5002, 'Junqueirà³polis', 26),
        (5003, 'Juquiá', 26),
        (5004, 'Juquitiba', 26),
        (5005, 'Lagoinha', 26),
        ...
        (5016, 'Louveira', 26),
        (5017, 'Lucà©lia', 26),
        (5018, 'Lucianà³polis', 26),
        (5019, 'Luà­s Antà´nio', 26),
        (5020, 'Luizià¢nia', 26),
        (5021, 'Lupà©rcio', 26),
        (5022, 'Lutà©cia', 26),
        (5023, 'Macatuba', 26),
        ...
        (5033, 'Mariápolis', 26),
        (5034, 'Marà­lia', 26),
        (5035, 'Marinà³polis', 26),
        (5036, 'Martinà³polis', 26),
        (5037, 'Matão', 26),
        (5038, 'Mauá', 26),
        (5039, 'Mendonà§a', 26),
        (5040, 'Meridiano', 26),
        (5041, 'Mesà³polis', 26),
        (5042, 'Miguelà³polis', 26),
        (5043, 'Mineiros do Tietàª', 26),
        (5044, 'Mira Estrela', 26),
        (5045, 'Miracatu', 26),
        (5046, 'Mirandà³polis', 26),
        (5047, 'Mirante do Paranapanema', 26),
        (5048, 'Mirassol', 26),
        (5049, 'Mirassolà¢ndia', 26),
        (5050, 'Mococa', 26),
        ...
        (5071, 'Nazarà© Paulista', 26),
        (5072, 'Neves Paulista', 26),
        (5073, 'Nhandeara', 26),
        (5074, 'Nipoã', 26),
        (5075, 'Nova Alianà§a', 26),
        ...
        (5082, 'Nova Independàªncia', 26),
        (5083, 'Nova Luzità¢nia', 26),
        (5084, 'Nova Odessa', 26),
        (5085, 'Novais', 26),
        ...
        (5112, 'Parapuã', 26),
        (5113, 'Pardinho', 26),
        (5114, 'Pariquera-Aà§u', 26),
        (5115, 'Parisi', 26),
        (5116, 'Patrocà­nio Paulista', 26),
        (5117, 'Paulicà©ia', 26),
        (5118, 'Paulà­nia', 26),
        (5119, 'Paulistà¢nia', 26),
        (5120, 'Paulo de Faria', 26),
        (5121, 'Pederneiras', 26),
        (5122, 'Pedra Bela', 26),
        (5123, 'Pedranà³polis', 26),
        (5124, 'Pedregulho', 26),
        (5125, 'Pedreira', 26),
        ...
        (5180, 'Rafard', 26),
        (5181, 'Rancharia', 26),
        (5182, 'Redenà§ão da Serra', 26),
        (5183, 'Regente Feijà³', 26),
        (5184, 'Reginà³polis', 26),
        (5185, 'Registro', 26),
        (5186, 'Restinga', 26),
        (5187, 'Ribeira', 26),
        ...
        (5240, 'Santana de Parnaà­ba', 26),
        (5241, 'Santo Anastácio', 26),
        (5242, 'Santo Andrà©', 26),
        (5243, 'Santo Antà´nio da Alegria', 26),
        (5244, 'Santo Antà´nio de Posse', 26),
        (5245, 'Santo Antà´nio do Aracanguá', 26),
        (5246, 'Santo Antà´nio do Jardim', 26),
        (5247, 'Santo Antà´nio do Pinhal', 26),
        (5248, 'Santo Expedito', 26),
        (5249, 'Santà³polis do Aguapeà­', 26),
        (5250, 'Santos', 26),
        (5251, 'São Bento do Sapucaà­', 26),
        ...
        (5261, 'São Josà© da Bela Vista', 26),
        (5262, 'São Josà© do Barreiro', 26),
        (5263, 'São Josà© do Rio Pardo', 26),
        (5264, 'São Josà© do Rio Preto', 26),
        (5265, 'São Josà© dos Campos', 26),
        (5266, 'São Lourenà§o da Serra', 26),
        (5267, 'São Luà­s do Paraitinga', 26),
        (5268, 'São Manuel', 26),
        ...
        (5278, 'Sarapuà­', 26),
        (5279, 'Sarutaiá', 26),
        (5280, 'Sebastianà³polis do Sul', 26),
        (5281, 'Serra Azul', 26),
        (5282, 'Serra Negra', 26),
        (5283, 'Serrana', 26),
        (5284, 'Sertãozinho', 26),
        ...
        (5360, 'Canhoba', 25),
        (5361, 'Canindà© de São Francisco', 25),
        (5362, 'Capela', 25),
        (5363, 'Carira', 25),
        (5364, 'Carmà³polis', 25),
        ...
        (5394, 'Nossa Senhora da Glà³ria', 25),
        ...
        (5425, 'Umbaàºba', 25),
        (5426, 'Abreulà¢ndia', 27),
        (5427, 'Aguiarnà³polis', 27),
        (5428, 'Alianà§a do Tocantins', 27),
        (5429, 'Almas', 27),
        (5430, 'Alvorada', 27),
        (5431, 'Ananás', 27),
        (5432, 'Angico', 27),
        ...
        (5464, 'Colmà©ia', 27),
        (5465, 'Combinado', 27),
        (5466, 'Conceià§ão do Tocantins', 27),
        (5467, 'Couto de Magalhães', 27),
        (5468, 'Cristalà¢ndia', 27),
        (5469, 'Crixás do Tocantins', 27),
        (5470, 'Darcinà³polis', 27),
        (5471, 'Dianà³polis', 27),
        (5472, 'Divinà³polis do Tocantins', 27),
        (5473, 'Dois Irmãos do Tocantins', 27),
        (5474, 'Duerà©', 27),
        (5475, 'Esperantina', 27),
        (5476, 'Fátima', 27),
        (5477, 'Figueirà³polis', 27),
        (5478, 'Filadà©lfia', 27),
        ...
        (5495, 'Lavandeira', 27),
        (5496, 'Lizarda', 27),
        (5497, 'Luzinà³polis', 27),
        (5498, 'Marianà³polis do Tocantins', 27),
        (5499, 'Mateiros', 27),
        (5500, 'Maurilà¢ndia do Tocantins', 27),
        (5501, 'Miracema do Tocantins', 27),
        (5502, 'Miranorte', 27),
        (5503, 'Monte do Carmo', 27),
        (5504, 'Monte Santo do Tocantins', 27),
        (5505, 'Muricilà¢ndia', 27),
        (5506, 'Natividade', 27),
        (5507, 'Nazarà©', 27),
        (5508, 'Nova Olinda', 27),
        (5509, 'Nova Rosalà¢ndia', 27),
        (5510, 'Novo Acordo', 27),
        (5511, 'Novo Alegre', 27),
        (5512, 'Novo Jardim', 27),
        ...
        (5517, 'Palmeirà³polis', 27),
        (5518, 'Paraà­so do Tocantins', 27),
        (5519, 'Paranã', 27),
        (5520, 'Pau d`Arco', 27),
        ...
        (5533, 'Pugmil', 27),
        (5534, 'Recursolà¢ndia', 27),
        (5535, 'Riachinho', 27),
        (5536, 'Rio da Conceià§ão', 27),
        (5537, 'Rio dos Bois', 27),
        (5538, 'Rio Sono', 27),
        (5539, 'Sampaio', 27),
        (5540, 'Sandolà¢ndia', 27),
        (5541, 'Santa Fà© do Araguaia', 27),
        ...
        (5548, 'São Fà©lix do Tocantins', 27),
        (5549, 'São Miguel do Tocantins', 27),
        (5550, 'São Salvador do Tocantins', 27),
        (5551, 'São Sebastião do Tocantins', 27),
        (5552, 'São Valà©rio da Natividade', 27),
        (5553, 'Silvanà³polis', 27),
        (5554, 'Sà­tio Novo do Tocantins', 27),
        (5555, 'Sucupira', 27),
        (5556, 'Taguatinga', 27),
